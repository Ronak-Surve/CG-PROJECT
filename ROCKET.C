...
delay(150);
outtextxy(50,150,"PSLV - C28 IS READY TO LAUNCH");
delay(150);
outtextxy(50,180,"IT CARRIES 5 SATELLITE TO DEPLOY ON THE MOON");
delay(150);
outtextxy(50,210,"SYNCHRONUOS ORBIT");
delay(150);
setcolor(RED);
outtextxy(50,240,"LAUNCH MASS -> 320000 KG");
delay(150);
outtextxy(50,270,"PAYLOAD MASS -> 1440 KG");
delay(150);
outtextxy(50,300,"LAUNCH SITE -> SATISH DHAWAN SPACE CENTRE");
delay(150);
outtextxy(50,330,"DISTANCE TRAVEL -> 647 KM");
delay(150);
outtextxy(50,360,"PRESS ENTER TO CONTINUE");
delay(150);
}
